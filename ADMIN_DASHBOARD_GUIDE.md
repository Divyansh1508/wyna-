...
- Backend should be running on `http://72.61.238.132:5000`
...
1. Check if backend is running: `http://72.61.238.132:5000/api/health`
...
2. Verify backend is responding: `http://72.61.238.132:5000/api/products`
3. Make sure database is seeded with sample data

## 🎯 Quick Links

- **Frontend**: http://localhost:3000
- **Backend API**: http://72.61.238.132:5000/api
