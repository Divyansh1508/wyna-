...
The server will start on `http://72.60.202.38:5000`
...
- **API Base URL**: `http://72.60.202.38:5000/api`
- **Health Check**: `http://72.60.202.38:5000/api/health`
...
Register a new user:
```bash
curl -X POST http://72.60.202.38:5000/api/auth/register \
...
Login:
```bash
curl -X POST http://72.60.202.38:5000/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "email": "test@example.com",
    "password": "password123"
...
4. Set environment variables:
   - `BASE_URL`: http://72.60.202.38:5000/api
