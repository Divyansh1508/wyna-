...
The backend server is currently running at: `http://72.61.238.132:5000`
...
# Get categories
curl http://72.61.238.132:5000/api/categories
```
...
---
*Backend running at http://72.61.238.132:5000*
