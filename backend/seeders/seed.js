...
const products = [
  ...
  },
  {
    ...
    description: 'Elevate any workspace with this luxurious executive desk set. Perfect for corporate gifting to senior management and valued clients. Includes premium leather desk pad, gold-plated pen holder, business card stand, and a sophisticated desk clock.',
    price: 4500,
    category: 'Corporate Gifting',
    stock: 30,
    features: [
  ...
  // Gift Hampers (3 products)
  {
    ...
    description: 'Indulge in a curated selection of premium gourmet treats. This luxury hamper includes imported chocolates, exotic dry fruits, artisan cookies, premium tea collection, and honey. Beautifully packaged in an elegant wicker basket with decorative ribbon.',
    price: 3500,
    ...
    customizable: false,
    images: [
      { url: '/images/products/gourmet-hamper-1.jpg', alt: 'Luxury Gourmet Hamper' }
    ]
  },
  {
    name: 'Wellness & Spa Hamper',
    description: 'A rejuvenating collection of premium spa essentials. Features aromatic candles, essential oils, luxury bath salts, handmade soaps, face masks, and a plush towel set. Ideal for self-care and pampering.',
    price: 2800,
    category: 'Gift Hampers',
    stock: 35,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/spa-hamper-1.jpg', alt: 'Wellness & Spa Hamper' }
    ]
  },
  {
    name: 'Sweet Treats Hamper',
    description: 'A delightful assortment of traditional and modern sweets. Includes premium mithai, chocolate truffles, cookies, dry fruits, and festive treats. Perfect for celebrations and gifting during festivals.',
    price: 2200,
    category: 'Gift Hampers',
    stock: 60,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/sweet-hamper-1.jpg', alt: 'Sweet Treats Hamper' }
    ]
  },
  ...
  // Wedding Boxes / Customized Boxes (3 products)
  {
    ...
    description: 'An exquisite wedding gift box featuring intricate traditional designs. Includes compartments for sweets, dry fruits, and gifts. Finished with premium velvet lining and golden embellishments. Perfect for wedding favors and shagun.',
    price: 1500,
    ...
    customizable: true,
    images: [
      { url: '/images/products/royal-wedding-box-1.jpg', alt: 'Royal Wedding Gift Box' }
    ]
  },
  {
    name: 'Elegant Trousseau Box',
    description: 'Spacious and beautifully designed trousseau box with multiple compartments. Features mirror work, traditional embroidery, and durable construction. Ideal for storing jewelry, cosmetics, and precious items.',
    price: 3200,
    category: 'Wedding Boxes / Customized Boxes',
    stock: 25,
    features: [
    ...
    customizable: true,
    images: [
      { url: '/images/products/trousseau-box-1.jpg', alt: 'Elegant Trousseau Box' }
    ]
  },
  {
    name: 'Personalized Gift Box Set',
    description: 'Customizable gift boxes perfect for wedding favors and corporate events. Available in various sizes and colors. Can be personalized with names, logos, or messages. High-quality cardboard with elegant finishes.',
    price: 800,
    category: 'Wedding Boxes / Customized Boxes',
    stock: 200,
    features: [
    ...
    customizable: true,
    images: [
      { url: '/images/products/custom-box-1.jpg', alt: 'Personalized Gift Box Set' }
    ]
  },
  ...
  // Diwali Gifts (3 products)
  {
    ...
    description: 'Celebrate the festival of lights with this grand Diwali hamper. Includes decorative diyas, premium dry fruits, traditional sweets, Lakshmi-Ganesh idol, decorative rangoli, and festive candles. Beautifully packaged in traditional design.',
    price: 4200,
    ...
    customizable: false,
    images: [
      { url: '/images/products/diwali-premium-1.jpg', alt: 'Premium Diwali Hamper' }
    ]
  },
  {
    name: 'Silver Lakshmi Ganesh Coin Set',
    description: 'Auspicious pure silver coins featuring Goddess Lakshmi and Lord Ganesh. Comes in an elegant velvet box with certificate of authenticity. Perfect for Diwali puja and gifting to bring prosperity and blessings.',
    price: 5500,
    category: 'Diwali Gifts',
    stock: 50,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/silver-coin-1.jpg', alt: 'Silver Lakshmi Ganesh Coin Set' }
    ]
  },
  {
    name: 'Designer Diya Gift Set',
    description: 'Handcrafted decorative diyas with intricate designs and vibrant colors. Set of 6 brass diyas with traditional patterns. Includes wicks and decorative tray. Perfect for home decoration and gifting during Diwali.',
    price: 1800,
    category: 'Diwali Gifts',
    stock: 120,
    features: [
  ...
  // New Year / Christmas Gifts (3 products)
  {
    ...
    description: 'Spread Christmas cheer with this festive hamper. Includes premium chocolates, Christmas cookies, festive wine, decorative ornaments, Santa figurine, and holiday-themed treats. Wrapped in festive red and gold packaging.',
    price: 3800,
    ...
    customizable: false,
    images: [
      { url: '/images/products/christmas-joy-1.jpg', alt: 'Christmas Joy Hamper' }
    ]
  },
  {
    name: 'New Year Celebration Box',
    description: 'Ring in the new year with style! Features premium champagne, gourmet snacks, party poppers, decorative items, 2026 planner, and motivational cards. Perfect for celebrations and corporate gifting.',
    price: 4500,
    category: 'New Year / Christmas Gifts',
    stock: 60,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/new-year-box-1.jpg', alt: 'New Year Celebration Box' }
    ]
  },
  {
    name: 'Winter Warmth Gift Set',
    description: 'Cozy winter essentials perfect for the holiday season. Includes premium wool scarf, leather gloves, hot chocolate mix, aromatic candles, and a beautiful coffee mug. Wrapped in elegant winter-themed packaging.',
    price: 2900,
    category: 'New Year / Christmas Gifts',
    stock: 45,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/winter-warmth-1.jpg', alt: 'Winter Warmth Gift Set' }
    ]
  },
  ...
  // Antique Gifts (3 products)
  {
    ...
    description: 'Exquisite collection of antique brass artifacts. Includes traditional oil lamps, decorative bells, vintage figurines, and ornate containers. Each piece is handcrafted with intricate designs, perfect for home décor and collectors.',
    price: 6500,
    ...
    customizable: false,
    images: [
      { url: '/images/products/brass-antique-1.jpg', alt: 'Vintage Brass Showpiece Collection' }
    ]
  },
  {
    name: 'Heritage Wall Clock',
    description: 'Stunning vintage-style wall clock with Roman numerals and ornate frame. Features brass pendulum and intricate carved wooden frame. Battery-operated with silent movement. A timeless piece that adds elegance to any space.',
    price: 4800,
    category: 'Antique Gifts',
    stock: 15,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/heritage-clock-1.jpg', alt: 'Heritage Wall Clock' }
    ]
  },
  {
    name: 'Antique Jewelry Box',
    description: 'Beautiful vintage-style jewelry box with intricate carvings and mirror work. Features multiple compartments, velvet lining, and brass fittings. Hand-painted with traditional motifs. Perfect for storing precious jewelry and keepsakes.',
    price: 3500,
    category: 'Antique Gifts',
    stock: 30,
    features: [
    ...
    customizable: false,
    images: [
      { url: '/images/products/antique-jewelry-box-1.jpg', alt: 'Antique Jewelry Box' }
    ]
  }
];
